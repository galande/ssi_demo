...
exports.BaseAgent = exports.indyNetworkConfig = void 0;
...
class BaseAgent {
    constructor({ port, name, endpoint, connectionImageUrl }) {
        this.name = name;
        this.port = port;
...
function getAskarAnonCredsIndyModules() {
    ...
    return {
        ...
        indyVdr: new indy_vdr_1.IndyVdrModule({
            ...
            networks: [exports.indyNetworkConfig],
        }),
