...
export declare class NodeJSAnoncreds implements Anoncreds {
    ...
    get nativeAnoncreds(): {
        ...
        anoncreds_create_w3c_credential: (args_0: number, args_1: number, args_2: number, args_3: number, args_4: Buffer, args_5: Buffer, args_6: number, args_7: string, args_8: Buffer) => unknown;
        anoncreds_process_w3c_credential: (args_0: number, args_1: number, args_2: string, args_3: number, args_4: number, args_5: Buffer) => unknown;
        anoncreds_create_w3c_presentation: (args_0: number, args_1: Buffer, args_2: Buffer, args_3: string, args_4: Buffer, args_5: Buffer, args_6: Buffer, args_7: Buffer, args_8: string, args_9: Buffer) => unknown;
        anoncreds_verify_w3c_presentation: (args_0: number, args_1: number, args_2: Buffer, args_3: Buffer, args_4: Buffer, args_5: Buffer, args_6: Buffer, args_7: Buffer, args_8: Buffer, args_9: Buffer, args_10: Buffer) => unknown;
        anoncreds_credential_to_w3c: (args_0: number, args_1: string, args_2: string, args_3: Buffer) => unknown;
        anoncreds_credential_from_w3c: (args_0: number, args_1: Buffer) => unknown;
        anoncreds_w3c_credential_get_integrity_proof_details: (args_0: number, args_1: Buffer) => unknown;
        anoncreds_w3c_credential_proof_get_attribute: (args_0: number, args_1: string, args_2: Buffer) => unknown;
        anoncreds_w3c_presentation_from_json: (args_0: Buffer, args_1: Buffer) => unknown;
        anoncreds_w3c_credential_from_json: (args_0: Buffer, args_1: Buffer) => unknown;
    };
    ...
    credentialFromW3c(options: {
        objectHandle: ObjectHandle;
    }): ObjectHandle;
    w3cCredentialGetIntegrityProofDetails(options: {
        objectHandle: ObjectHandle;
    }): ObjectHandle;
    w3cCredentialProofGetAttribute(options: {
        objectHandle: ObjectHandle;
        name: string;
    }): string;
    w3cCredentialFromJson(options: {
        json: string;
    }): ObjectHandle;
    w3cPresentationFromJson(options: {
        json: string;
    }): ObjectHandle;
    version(): string;
    ...
    private convertCredentialList;
    private convertCredentialProves;
    private convertSchemas;
    private convertCredDefs;
    private convertNonRevokedIntervalOverrides;
    private convertAttributeNames;
    private convertAttributeRawValues;
    private convertAttributeEncodedValues;
    private convertRevocationConfiguration;
}
