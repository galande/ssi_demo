...
export declare class Credential extends AnoncredsObject {
    static create(options: CreateCredentialOptions): Credential;
    static fromJson(json: JsonObject): Credential;
    process(options: ProcessCredentialOptions): this;
    get schemaId(): string;
    get credentialDefinitionId(): string;
    get revocationRegistryId(): string;
    get revocationRegistryIndex(): number | undefined;
    toW3c(options: CredentialToW3cOptions): W3cCredential;
    static fromW3c(options: CredentialFromW3cOptions): Credential;
}
