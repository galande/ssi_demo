...
class Credential extends AnoncredsObject_1.AnoncredsObject {
    ...
    toW3c(options) {
        return new W3cCredential_1.W3cCredential(register_1.anoncreds.credentialToW3c({
            objectHandle: this.handle,
            issuerId: options.issuerId,
            w3cVersion: options.w3cVersion
        }).handle);
    }
    static fromW3c(options) {
        return new Credential(register_1.anoncreds.credentialFromW3c({ objectHandle: options.credential.handle }).handle);
    }
}
