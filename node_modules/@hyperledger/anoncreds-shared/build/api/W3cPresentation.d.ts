...
export declare class W3cPresentation extends AnoncredsObject {
    static create(options: CreateW3cPresentationOptions): W3cPresentation;
    static fromJson(json: JsonObject): W3cPresentation;
    verify(options: VerifyW3cPresentationOptions): boolean;
}
