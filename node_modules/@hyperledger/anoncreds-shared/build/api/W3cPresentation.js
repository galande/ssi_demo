...
class W3cPresentation extends AnoncredsObject_1.AnoncredsObject {
    static create(options) {
        ...
        try {
            ...
            presentationHandle = register_1.anoncreds.createW3cPresentation({
                presentationRequest,
                credentials: options.credentials.map((item) => ({
                    credential: item.credential instanceof W3cCredential_1.W3cCredential
                        ? item.credential.handle
                        : (0, utils_1.pushToArray)(W3cCredential_1.W3cCredential.fromJson(item.credential).handle, objectHandles),
    ...
    static fromJson(json) {
        return new W3cPresentation(register_1.anoncreds.w3cPresentationFromJson({ json: JSON.stringify(json) }).handle);
    }
    verify(options) {
        var _a;
        ...
        try {
            const presentationRequest = options.presentationRequest instanceof PresentationRequest_1.PresentationRequest
                ? options.presentationRequest.handle
                : (0, utils_1.pushToArray)(PresentationRequest_1.PresentationRequest.fromJson(options.presentationRequest).handle, objectHandles);
            verified = register_1.anoncreds.verifyW3cPresentation({
