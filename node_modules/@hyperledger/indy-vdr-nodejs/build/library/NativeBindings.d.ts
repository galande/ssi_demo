...
export interface NativeMethods {
    ...
    indy_vdr_build_acceptance_mechanisms_request: (arg0: string, arg1: string, arg2: string, arg3: string, requestHandlePtr: Buffer) => number;
    indy_vdr_build_attrib_request: (arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_build_get_acceptance_mechanisms_request: (arg0: string, arg1: number, arg2: string, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_build_get_revoc_reg_delta_request: (arg0: string, arg1: string, arg2: number, arg3: number, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_build_get_attrib_request: (arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: number, arg6: number, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_build_revoc_reg_entry_request: (arg0: string, arg1: string, arg2: string, arg3: string, requestHandlePtr: Buffer) => number;
    indy_vdr_build_schema_request: (arg0: string, arg1: string, requestHandlePtr: Buffer) => number;
    indy_vdr_build_txn_author_agreement_request: (arg0: string, arg1: string, arg2: string, arg3: number, arg4: number, requestHandlePtr: Buffer) => number;
    indy_vdr_build_get_txn_author_agreement_request: (arg0: string, arg1: string, requestHandlePtr: Buffer) => number;
    indy_vdr_build_get_nym_request: (arg0: string, arg1: string, arg2: number, arg3: number, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_build_nym_request: (arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: number, requestHandlePtr: Buffer) => number;
    ...
    indy_vdr_pool_submit_action: (poolHandle: number, requestHandle: number, arg0: string, arg1: number, callBackPtr: Buffer, callbackId: number) => number;
    indy_vdr_pool_submit_request: (poolHandle: number, requestHandle: number, callBackPtr: Buffer, callbackId: number) => number;
    ...
    indy_vdr_prepare_txn_author_agreement_acceptance: (arg0: string, arg1: string, arg2: string, arg3: string, arg4: number, outputPtr: Buffer) => number;
