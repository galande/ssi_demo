...
export declare class RevocationRegistryEntryRequest extends IndyVdrRequest<RevocationRegistryEntryResponse> {
    constructor(options: RevocationRegistryEntryRequestOptions);
}
export {};
