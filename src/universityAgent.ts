...
const seed = `acme12issuerdidseed0000000000000` // What you input on bcovrin. Should be kept secure in production!
const unqualifiedIndyDid = `3HJ6pgeff6LaikBPaqbY3k` // will be returned after registering seed on bcovrin
